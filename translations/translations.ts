export const translations: Record<'en' | 'es' | 'ca', { 
  ...
  en: {
    ...
    start_placeholder: 'Speak Here',
    click_for_details: 'Click for details',
    no_results_message: 'Options will appear here',
    ...
    report_send_failure_message: 'There was a problem generating or sending the report, or content unavailable. Please try again.',
  ...
  es: {
    ...
    start_placeholder: 'Hable aquí',
    click_for_details: 'Ver detalles',
    no_results_message: 'Opciones aquí',
    ...
    report_send_failure_message: 'Hubo un problema al generar o enviar el informe, o no existe contenido. Inténtelo nuevamente',
  ...
  ca: {
    ...
    start_placeholder: 'Parla aqui',
    click_for_details: 'Veure més',
    no_results_message: 'Opcions aqui',
    ...
    report_send_failure_message: 'Problema en generar o enviar l\'informe, o contingut inexistent. Intenteu-ho novament',
